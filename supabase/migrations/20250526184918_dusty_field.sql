/*
  # Create churn prediction tables and policies
...
-- Create churn_model_metrics table if it doesn't exist
...
-- Create churn_actions table if it doesn't exist
...
-- Create policies for churn_predictions if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Create policies for churn_model_metrics if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
...
-- Create policies for churn_actions if they don't exist
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
